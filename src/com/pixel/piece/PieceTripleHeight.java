...
public class PieceTripleHeight extends PieceInfo{
	...
	public void render(GameContainer c, Graphics g, World w, Piece p) {
		...
		if (image != null) 
			image.draw(p.posX*World.tileConstant+World.globalOffsetX, p.posY*World.tileConstant-World.tileConstant*2+World.globalOffsetY, World.tileConstant, World.tileConstant*3);
		else {
